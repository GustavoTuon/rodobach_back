CREATE TABLE IF NOT EXISTS usuarios (
  ...
  perm_faturamento_diario BOOLEAN NOT NULL DEFAULT TRUE,
  perm_comparativo_faturamento BOOLEAN NOT NULL DEFAULT TRUE,
  perm_analise_frota    BOOLEAN NOT NULL DEFAULT TRUE,
  perm_lucro_viagens    BOOLEAN NOT NULL DEFAULT TRUE,
